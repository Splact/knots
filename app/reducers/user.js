...
const reducerMap = {
  ...
  [USER_LOGOUT_REQUESTED]: (state) => {
    return Object.assign({}, state, {
      isLoggingOut: true
    });
  },
  [USER_LOGOUT_SUCCEEDED]: (state) => {
    return Object.assign({}, state, {
      token: null,
      isLogged: false,
      isLoggingOut: false
  ...
  [USER_LOGOUT_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isLoggingOut: false,
      error: action.payload
    });
  ...
  [USER_UPDATE_POSITION_REQUESTED]: (state) => {
    return Object.assign({}, state, {
      isUpdatingPosition: true
    });
  },
  [USER_UPDATE_POSITION_SUCCEEDED]: (state, action) => {
    return Object.assign({}, state, {
      position: action.payload,
      isUpdatingPosition: false
    });
  },
  [USER_UPDATE_POSITION_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isUpdatingPosition: false,
      error: action.payload
    });
