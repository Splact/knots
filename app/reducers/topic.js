...
const reducerMap = {
  ...
  [TOPIC_CREATE_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isCreating: false,
      error: action.payload
    });
  },
  [TOPIC_FETCH_REQUESTED]: (state) => {
    return Object.assign({}, state, {
      isFetching: true
    });
  },
  ...
  [TOPIC_FETCH_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isFetching: false,
      error: action.payload
    });
  },
  [TOPIC_DO_CHECKIN_REQUESTED]: (state) => {
    return Object.assign({}, state, {
      isChangingCheckin: true
    });
  },
  [TOPIC_DO_CHECKIN_SUCCEEDED]: (state, action) => {
    return Object.assign({}, state, {
      checkins: action.payload,
      isChangingCheckin: false
    });
  },
  [TOPIC_DO_CHECKIN_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isChangingCheckin: false,
      error: action.payload
    });
  },
  [TOPIC_UNDO_CHECKIN_REQUESTED]: (state) => {
    return Object.assign({}, state, {
      isChangingCheckin: true
    });
  },
  [TOPIC_UNDO_CHECKIN_SUCCEEDED]: (state, action) => {
    return Object.assign({}, state, {
      checkins: action.payload,
      isChangingCheckin: false
    });
  },
  [TOPIC_UNDO_CHECKIN_FAILED]: (state, action) => {
    return Object.assign({}, state, {
      isChangingCheckin: false,
      error: action.payload
    });
